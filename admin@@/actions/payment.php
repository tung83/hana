...
if (postt('do') == 'update') {
	...
	escape_post('title,eTitle,content,eContent,desc,eDesc,keyword,eKeyword');

	$fields = 'active,title,eTitle,content,eContent,desc,eDesc,keyword,eKeyword,view';
